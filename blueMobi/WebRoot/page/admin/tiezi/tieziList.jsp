...
<body>
	<div class="easyui-layout" data-options="fit:true,border:false">
		...
		<div data-options="region:'center',border:false"
			...
			<table id="priTB" title="帖子列表" style="width:inherit;height:auto;"
				pagination="true"
				data-options="fit:true,rownumbers:true,pagination:true,remoteSort:false,pageSize:10,pageList:[1,10,20],url:$('base')[0].href+'admin/tiezi/getTieziList.htm'">
				<thead>
					<th field="id" checkbox="true">序号</th>
					<th field="content" width="160" sortable="true" align="center">新闻内容</th>
					<th field="publishTime" width="160" sortable="true" align="center">发布时间</th>
					<th field="praiseNum" width="160" sortable="true" align="center">点赞数量</th>
					<th field="uName" width="160" sortable="true" align="center">发布人</th>
					<th field="communityName" width="160" sortable="true" align="center">所属圈子</th>
					...
					<th field="operate1" width="160" align="center" data-options='formatter: 
						function(value,row,index){
							return "<a href=javascript:void(0)>评论管理**</a>";
						}'>评论管理</th>
					<th field="operate2" width="160" align="center" data-options='formatter: 
						function(value,row,index){
	...
	$(function(){
		...
		$("#search").click(function(){
			$.ajax({
				url:"<%=basePath %>/admin/findDiscoveryListByCondition.htm",
				type:"POST",
				data:{
					"title":"通知",
					"status":"1"
